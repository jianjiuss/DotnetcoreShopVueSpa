    ...
    <div>
        ...
        <div class="mui-content" id="content">
            ...
            <div class="mui-content-padded">
                <button id='login' class="mui-btn mui-btn-block mui-btn-primary" v-on:click="login()">登录</button>
                <div class="link-area">
                    <router-link id='reg' :to="{name : 'Register'}">注册账号</router-link> <span class="spliter"></span>
                </div>
            </div>
...
export default {
    ...
    methods: {
        login: function () {
            this.$http.post('/api/user', this.user).then(function (res) {
